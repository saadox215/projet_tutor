...
const AdminDashboard = ({ user, onLogout }) => {
  ...
  const notifications = [
    { id: 1, text: "New professor account request", time: "1 hour ago" },
    { id: 2, text: "System update scheduled for tonight", time: "3 hours ago" },
    { id: 3, text: "5 new student registrations", time: "1 day ago" },
  ]

  const drawer = (
    <div>
      <Toolbar sx={{ display: "flex", alignItems: "center", justifyContent: "center", py: 1 }}>
        <SchoolIcon color="primary" sx={{ fontSize: 30, mr: 1 }} />
